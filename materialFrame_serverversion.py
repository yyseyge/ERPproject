...
class material_frame(tk.Frame): #자재조회 프레임 class, tk.Frame class를 상속받음
    ...
    #아래쪽 화면에 표 나오게 하는 부분
        ...
        # # sql4 = "SELECT * FROM materialtable"
        # # cursor.execute(sql4)
    ...
    def search(self):
        ...
        self.root.send_(json.dumps(send_d, ensure_ascii=False))
        # self.app1.refresh(send_d["args"])


    def modify(self): #수정할떄 실행되는 함수
       pass
